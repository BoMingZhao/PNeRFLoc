...
nrDataRoot="../data_src/"
name="office3_vox1600_datavos200_renderdepth"
train_end=2000
lr=0.001
n_threads=4
r2d2_feature=1
...
format=2
scan="office3"
save_path="../results/Replica/${scan}/pose"
serial_batches=1

per_epoch=300
render_times=1

resume_iter=30000 # 50000
...
z_depth_dim=400
max_o=200000
ranges=" -6.9 -7.7 -3.0 5.3 5.1 3.7 "
SR=24
K=8
P=26
NN=2
...
random_sample_size=500 #48 # 32 * 32 = 1024
batch_size=1
