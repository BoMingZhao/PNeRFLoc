...
nrDataRoot="../data_src/"
name='redkitchen_vox800_renderdepth_ColmapPose'
...
skip=10
rendering_only=1
pose_dir="${data_root}/7scenes_sfm_triangulated/"
...
geo_cnsst_num=0
edge_filter=50 # pixels crop out at image edge
...
kernel_size=" 5 5 5 "
query_size=" 3 3 3 "
vsize=" 0.009 0.009 0.009 " #" 0.005 0.005 0.005 "
wcoord_query=-1
z_depth_dim=400
max_o=200000
ranges=" -10.0 -8.0 -8.0 10.0 8.0 8.0 "
SR=24
K=8
P=26
NN=2
