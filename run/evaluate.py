...
try:
    ...
    def compare_ssim(gt, img, win_size):
        return structural_similarity(gt, img, win_size=win_size, channel_axis=-1, data_range=1)
...
parser.add_argument('-is', '--imgStr', default="step-%04d-coarse_raycolor.png", help="The string format for input images.")
parser.add_argument('-gs', '--gtStr', default="step-%04d-gt_image.png", help="The string format for GT images.")

parser.add_argument('-l', '--id_list', nargs='+', default=list(range(0, 2000, 200)),  help="The list of ids to test. By default it's 0~999.")
