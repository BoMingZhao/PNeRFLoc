...
class BaseOptions:
    def initialize(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            default='.pth',
            help='name of model, determine which r2d2 model to use')
        parser.add_argument('--rendering_only', type=int, default=1, help="1 for rendering, 0 for localization") # Delete later
        parser.add_argument('--train_end', type=int, default=4000, help="Training image end ID")
        parser.add_argument('--pre_loading', type=int, default=0, help="1 = Load pre-generated feature maps | 0 = Extract feature maps during training")
        parser.add_argument('--r2d2_feature', type=int, default=0, help="1 = Use r2d2 feature, 0 = Use ResNet CNN feature")
        #================================ running ================================#
