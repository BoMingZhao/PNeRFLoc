...
from models.localization.r2d2.patchNet import *
...
def load_r2d2_network(model_fn): 
...
def create_mvs(args, mvs_mode=-1, depth=128):
    ...
    net_localization = load_r2d2_network(args.localization_model).to(device)
    EncodingNet = None
    if mvs_mode == -1:
    ...
    render_kwargs_train = {
        ...
        'network_2d': net_2d,
        'network_localization': net_localization
    }
