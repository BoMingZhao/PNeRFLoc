...
def extract_keypoints(args):
    ...
    while args.images:
        ...
        output_name = os.path.basename(img_path) + '.' + args.tag
        output_dir = os.path.join(os.path.dirname(img_path), "../", args.output_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", type=str, default="r2d2_query")
